...
using AutoMapper;
using ComputerWebShopApp.Models.ViewModels.Products;
...
namespace ComputerWebShopApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductName,Description,Price,BrandId,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
